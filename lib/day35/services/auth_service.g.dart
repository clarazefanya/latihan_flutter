...
class _AuthService implements AuthService {
  ...
  Future<TrainingResponse> getTrainings() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TrainingResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/trainings',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TrainingResponse _value;
    try {
      _value = TrainingResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<BatchResponse> getBatches() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BatchResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/batches',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BatchResponse _value;
    try {
      _value = BatchResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
